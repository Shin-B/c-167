...
canvas=Canvas(root, width = 990, height)
canvas.pack()

label=Label(root,text=" Choose Color :")
label.place(relx=0.6,rely=0.9, anchor= CENTER)

fillcolour=["green","yellow","red","blu"]
colour_dropdown = ttk.Combobox(root,state="readonly", values=fillcoulour,width=10)
...
coordinates_balues[10,50,100,200,300,400,500,600,800,900]
...
endy.placed(relx=0.7, rely = 0.85, anchor=CENTER)
